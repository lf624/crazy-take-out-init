CREATE DATABASE  IF NOT EXISTS `crazy_take_out` ;
USE `crazy_take_out`;
...
CREATE TABLE `address_book` (
  ...
  `detail` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '详细地址',
...
CREATE TABLE `employee` (
  ...
  `phone` varchar(11) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '手机号',
  `sex` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '性别',
...
CREATE TABLE `orders` (
  ...
  `consignee` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '收货人',
  `cancel_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订单取消原因',
  `rejection_reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '订单拒绝原因',
...
CREATE TABLE `setmeal_dish` (
  ...
  `setmeal_id` bigint DEFAULT NULL COMMENT '套餐id',
  `dish_id` bigint DEFAULT NULL COMMENT '菜品id',
  `name` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '菜品名称 （冗余字段）',
...
CREATE TABLE `shopping_cart` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '商品名称',
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片',
